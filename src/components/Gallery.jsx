...
// Import 4 sample images from your list
import im1 from "../Images/im9.jpg";
import im2 from "../Images/im2.jpg";
import im3 from "../Images/im6.jpg";
import im4 from "../Images/im29.jpg";
  ...
  return (
    <GallerySection>
      <GalleryHeader>
        ...
        <p>Discover a glimpse of our collection. Explore the full gallery for more amazing visuals.</p>
      </GalleryHeader>

      <GalleryGrid>
        <GalleryItem image={im1} />
        <GalleryItem image={im2} />
        <GalleryItem image={im3} />
        <GalleryItem image={im4} />
      </GalleryGrid>

      <ViewMoreButton onClick={() => navigate("/gallery")}>View More</ViewMoreButton>
    </GallerySection>
  );
};
